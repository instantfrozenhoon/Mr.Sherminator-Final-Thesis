...
public class CaveFive : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (levelClearRange)
        {
            ...
            if (currentTime <= 40f)
            {
                int starScore = PlayerPrefs.GetInt("CaveFiveScore");

                if (starScore <= 3)
                {

                    PlayerPrefs.SetInt("CaveFiveScore", 3);
            ...
            else if (currentTime > 40 && currentTime <= 60)
            {
                ...
                if (starScore <= 2)
                {
                    ...
                    PlayerPrefs.SetInt("CaveFiveScore", 2);
            ...
            else if (currentTime > 60)
            {
                ...
                if (starScore <= 2)
                {
                    PlayerPrefs.SetInt("CaveFiveScore", 1);
