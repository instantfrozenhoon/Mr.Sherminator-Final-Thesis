...
public class DungeonTwo : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (levelClearRange)
        {
            ...
            if (currentTime <= 40f)
            {
                int starScore = PlayerPrefs.GetInt("DungeonTwoScore");

                if (starScore <= 3)
                {

                    PlayerPrefs.SetInt("DungeonTwoScore", 3);
            ...
            else if (currentTime > 40 && currentTime <= 60)
            {
                ...
                if (starScore <= 2)
                {
                    ...
                    PlayerPrefs.SetInt("DungeonTwoScore", 2);
            ...
            else if (currentTime > 60)
            {
                ...
                if (starScore <= 2)
                {
                    PlayerPrefs.SetInt("DungeonTwoScore", 1);
