...
public class DungeonFive : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (levelClearRange)
        {
            ...
            if (currentTime <= 40f)
            {
                int starScore = PlayerPrefs.GetInt("DungeonFiveScore");

                if (starScore <= 3)
                {

                    PlayerPrefs.SetInt("DungeonFiveScore", 3);
            ...
            else if (currentTime > 40 && currentTime <= 60)
            {
                ...
                if (starScore <= 2)
                {
                    ...
                    PlayerPrefs.SetInt("DungeonFiveScore", 2);
            ...
            else if (currentTime > 60)
            {
                ...
                if (starScore <= 2)
                {
                    PlayerPrefs.SetInt("DungeonFiveScore", 1);
