...
public class CaveTwo : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (levelClearRange)
        {
            ...
            if (currentTime <= 40f)
            {
                int starScore = PlayerPrefs.GetInt("CaveTwoScore");

                if (starScore <= 3)
                {

                    PlayerPrefs.SetInt("CaveTwoScore", 3);
            ...
            else if (currentTime > 40 && currentTime <= 60)
            {
                ...
                if (starScore <= 2)
                {
                    ...
                    PlayerPrefs.SetInt("CaveTwoScore", 2);
            ...
            else if (currentTime > 60)
            {
                ...
                if (starScore <= 2)
                {
                    PlayerPrefs.SetInt("CaveTwoScore", 1);
