...
public class DungeonFour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (levelClearRange)
        {
            ...
            if (currentTime <= 40f)
            {
                int starScore = PlayerPrefs.GetInt("DungeonFourScore");

                if (starScore <= 3)
                {

                    PlayerPrefs.SetInt("DungeonFourScore", 3);
            ...
            else if (currentTime > 40 && currentTime <= 60)
            {
                ...
                if (starScore <= 2)
                {
                    ...
                    PlayerPrefs.SetInt("DungeonFourScore", 2);
            ...
            else if (currentTime > 60)
            {
                ...
                if (starScore <= 2)
                {
                    PlayerPrefs.SetInt("DungeonFourScore", 1);
